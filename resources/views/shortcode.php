...
if (isset($metagallery['images'])) {
    // Settings with defaults. Could probably start extracting to a helper class.
    ...
    <div
        ...
        style="position:relative!important;width:100%!important;max-width:100%!important;<?php echo 'margin:-' . \esc_attr($metagalleryImageSpacing); ?>">
    <?php
