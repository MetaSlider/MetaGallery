...
<div
    ...
    @open-modal.window="updateData($event);setTimeout(() => $refs.article.focus(), 10)">
    <article
        ...
        */
        ...
        <div class="sm:flex sm:items-start">
            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-nord6 text-nord11 sm:mx-0 sm:h-10 sm:w-10">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2" x-text="content"></div>
            </div>
        </div>
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <button
                ...
                x-text="actionLabel"
                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-nord11 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-nord11 sm:ml-3 sm:w-auto sm:text-sm">
            </button>
            <button
            type="button"
