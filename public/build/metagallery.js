(function (factory) {
	  ...
	  return {
	    ...
	    init: function init() {
	      ...
	      this.manager.on('select', function () {
	        ...
	        var images = selection.filter(function (image) {
	...
	function Gallery() {
	  return {
	    ...
	    addImages: function addImages(images) {
	      ...
	      window.metagalleryGrid.add(images.map(function (i) {
	    ...
	    removeImages: function removeImages(images) {
	      ...
	      window.metagalleryGrid.remove(images.map(function (i) {
	...
	function Current(data) {
	  return {
	    ...
	    addImages: function addImages(images) {
	      ...
	      window.dispatchEvent(new CustomEvent('metagallery-images-added', {
	        detail: {
	          images: images
	        },
	        bubbles: true
	...
	*/
	...
	function isPlainObject$1(val) {
	  return typeof val === objectType && toString$2.call(val) === objectToStringType;
	}
	  ...
	  if (item._migrate._isActive && item._isActive) {
	    if (layoutSender) {
	      this.layout(
	        ...
	        isFunction$1(layoutSender) ? layoutSender : undefined
	      );
	    }
	    if (layoutReceiver) {
	      targetGrid.layout(
