;(function (factory) {
                    ...
                    Alpine.addMagicProperty('interval', function () {
                        return function () {
                            ...
                            var loop = function loop() {
                                var test = Object.prototype.hasOwnProperty.call(_this, 'autoIntervalTest')
                                    ? _this.autoIntervalTest
                                    : true
                                setTimeout(function () {
                                    if (!_this.autoIntervalLoop) return
                                    test && parameters[0].call(_this)
                                    forceInterval
                                        ? _this.autoIntervalLoop()
                                        : requestAnimationFrame(_this.autoIntervalLoop)
                                }, timer)
                            }
                    ...
                    Alpine.addMagicProperty('truncate', function () {
                        return function () {
                            ...
                            if (Object.prototype.hasOwnProperty.call(parameters[1], 'words') && parameters[1].words) {
                                return _this.appendEllipsis(
                                    parameters[0].split(' ').splice(0, parameters[1].words).join(' '),
                                    parameters,
                                )
                            }

                            if (
                                Object.prototype.hasOwnProperty.call(parameters[1], 'characters') &&
                                parameters[1].characters
                            ) {
                                return _this.appendEllipsis(
                                    parameters[0].slice(0, parameters[1].characters),
                                    parameters,
                                )
                            }
    ...
    var Gallery = {
        ...
        save: function save(id, title, images, settings) {
            ...
            return Axios$1.post('gallery/' + id, formData, {
                headers: {
    ...
    ScrollRequest.prototype.onStart = function () {
        ...
        if (isFunction$1(onStart)) onStart(item, this.element, this.direction)
    }

    ScrollRequest.prototype.onStop = function () {
        var item = this.item
        var onStop = getItemAutoScrollSettings(item).onStop
        if (isFunction$1(onStop)) onStop(item, this.element, this.direction)
    ...
    AutoScroller.prototype._checkItemOverlap = function (item, checkX, checkY) {
        ...
        var targets = isFunction$1(settings.targets) ? settings.targets(item) : settings.targets
    ...
    function ItemDrag(item) {
        ...
        this._startPredicate = isFunction$1(settings.dragStartPredicate)
    ...
    ItemDrag.prototype._checkOverlap = function () {
        ...
        if (isFunction$1(settings.dragSortPredicate)) {
    ...
    function isNative(feat) {
        var S = window.Symbol
        return !!(feat && isFunction$1(S) && isFunction$1(S.toString) && S(feat).toString().indexOf(nativeCode) > -1)
    }
    ...
    var HAS_WEB_ANIMATIONS = !!(Element && isFunction$1(Element.prototype.animate))
    ...
    Animator.prototype.start = function (propsFrom, propsTo, options) {
        ...
        if (!HAS_WEB_ANIMATIONS) {
            ...
            this._callback = isFunction$1(opts.onFinish) ? opts.onFinish : null
            this._onFinish()
            return
        }
    ...
    ItemDragPlaceholder.prototype.create = function () {
        ...
        var element
        if (isFunction$1(settings.dragPlaceholder.createElement)) {
        ...
        // onCreate hook.
        if (isFunction$1(settings.dragPlaceholder.onCreate)) {
    ...
    ItemDragPlaceholder.prototype.reset = function () {
        ...
        if (isFunction$1(settings.dragPlaceholder.onRemove)) {
    ...
    ItemVisibility.prototype.show = function (instant, onFinish) {
        ...
        var item = this._item
        var element = item._element
        var callback = isFunction$1(onFinish) ? onFinish : null
        var grid = item.getGrid()
        var settings = grid._settings
    ...
    function Grid(element, options) {
        ...
        if (!isFunction$1(settings.dragSort)) {
    ...
    Grid.prototype.layout = function (instant, onFinish) {
        ...
        if (unfinishedLayout && isFunction$1(unfinishedLayout.cancel)) {
        ...
        var cancelLayout
        if (isFunction$1(layoutSettings)) {
        ...
        if (isFunction$1(cancelLayout) && this._nextLayoutData && this._nextLayoutData.id === nextLayoutId) {
    ...
    Grid.prototype.add = function (elements, options) {
        ...
        if (needsLayout && layout) {
            this.layout(layout === INSTANT_LAYOUT, isFunction$1(layout) ? layout : undefined)
        }
    ...
    Grid.prototype.filter = function (predicate, options) {
        ...
        var isPredicateFn = isFunction$1(predicate)
        var opts = options || {}
        var isInstant = opts.instant === true
        var syncWithLayout = opts.syncWithLayout
        var layout = opts.layout ? opts.layout : opts.layout === undefined
        var onFinish = isFunction$1(opts.onFinish) ? opts.onFinish : null
    ...
    Grid.prototype.send = function (item, targetGrid, position, options) {
        ...
        if (item._migrate._isActive && item._isActive) {
            if (layoutSender) {
                this.layout(layoutSender === INSTANT_LAYOUT, isFunction$1(layoutSender) ? layoutSender : undefined)
            }
            if (layoutReceiver) {
                targetGrid.layout(
                    layoutReceiver === INSTANT_LAYOUT,
                    isFunction$1(layoutReceiver) ? layoutReceiver : undefined,
                )
            }
        }
    ...
    Grid.prototype._onLayoutDataReceived = (function () {
        ...
        return function (layout) {
            ...
            var tryFinish = function () {
                ...
                var callback = isFunction$1(instant) ? instant : onFinish
    ...
    Grid.prototype._setItemsVisibility = function (items, toVisible, options) {
        ...
        if (!counter) {
            if (isFunction$1(callback)) callback(targetItems)
            return
        }
        ...
        function triggerVisibilityChange() {
            ...
            for (i = 0; i < targetItems.length; i++) {
                ...
                if (targetItems[i]._gridId !== grid._id) {
                    if (--counter < 1) {
                        if (isFunction$1(callback)) callback(completedItems.slice(0))
    ...
    function mergeObjects(target, source) {
        ...
        for (i = 0; i < length; i++) {
            ...
            isSourceObject = isPlainObject$1(source[propName])

            // If target and source values are both objects, merge the objects and
            // assign the merged value to the target property.
            if (isPlainObject$1(target[propName]) && isSourceObject) {
